"""Model-backend resolver for Lab 06 — chat + embeddings, provider-agnostic.

Same pattern as Lab 02: talk to an OpenAI-compatible API, base_url picks the
backend. See labs/model-backends.md.
"""
